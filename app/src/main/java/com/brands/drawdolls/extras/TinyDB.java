...
package com.brands.drawdolls.extras;
...
public class TinyDB {
    ...
    public ArrayList<Doll> getDollsList(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Doll> objects = new ArrayList<>();

        for(String jObjString : objStrings){
            Doll value  = gson.fromJson(jObjString, Doll.class);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putDollList(String key, ArrayList<Doll> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Doll obj : objArray){
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
    }
